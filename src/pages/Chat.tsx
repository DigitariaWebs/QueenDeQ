      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6 pt-24">
        ...
        >
          <div className="relative">
            ...
            <div className="absolute -top-8 -right-8 transform rotate-12">
              <div className="bg-gradient-to-r from-rose-champagne to-imperial-gold text-white px-4 py-2 rounded-lg shadow-lg border-2 border-white">
                <div className="flex items-center gap-2">
                  <Sparkles size={14} />
                  <span className="text-sm font-bold font-raleway">BETA</span>
                  <Coffee size={14} />
                </div>
              </div>
            </div>
            ...
            <h1 className="relative font-playlist text-4xl md:text-5xl font-bold text-royal-purple mb-4">
              {t('chat.title')}
            </h1>
        ...
        >
          <div className="bg-white/70 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-imperial-gold/30 max-w-lg mx-auto relative">
            {/* Beta Badge */}
            <div className="absolute -top-3 -right-3 bg-gradient-to-r from-imperial-gold to-rose-champagne text-royal-purple px-3 py-1 rounded-full text-xs font-bold shadow-lg transform rotate-6 font-raleway">
              {t('chat.comingSoon')}
            </div>

            <div className="flex items-center justify-center gap-3 mb-4">
              <BookOpen className="text-imperial-gold" size={24} />
              <h3 className="font-cinzel text-xl font-bold text-royal-purple">
                {t('chat.awakeningTitle')}
              </h3>
              <Coffee className="text-amber-600" size={24} />
            </div>
            
            <div className="text-royal-purple/80 text-sm leading-relaxed space-y-3 font-raleway">
              <p>
              ...
              <p className="text-xs text-royal-purple/60 mt-4 font-raleway">
