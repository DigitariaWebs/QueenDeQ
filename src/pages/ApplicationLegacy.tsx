      ...
      >
        ...
        >
          <div className="relative inline-block">
            ...
            <h1 className="font-playlist text-5xl md:text-7xl font-bold bg-gradient-to-r from-imperial-gold via-rose-champagne to-imperial-gold bg-clip-text text-transparent mb-4 pt-12">
              Queen de Q
            </h1>
            
            <motion.div
              className="text-4xl md:text-5xl font-cinzel font-bold text-imperial-gold mb-6"
              animate={{
                textShadow: [
            ...
            <motion.p 
              className="text-xl text-rose-champagne font-medium font-raleway"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        >
          <div className="relative bg-gradient-to-r from-royal-purple/30 via-vintage-aubergine/30 to-royal-purple/30 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-imperial-gold/30">
            ...
            <h2 className="font-cinzel text-3xl md:text-4xl font-bold text-imperial-gold mb-8">
              Tout de toi est complet
            </h2>
            
            <div className="space-y-4 text-lg md:text-xl text-rose-champagne leading-relaxed">
              <p className="font-raleway">T'as déconstruit. Analysé. Trop.</p>
              <p className="font-raleway">T'as été douce, forte, conciliante, sexy, brillante... parfois tout en même temps.</p>
              <p className="text-imperial-gold font-medium font-raleway">Et t'as quand même mangé des deux de piques.</p>
              <p className="text-2xl font-cinzel font-bold text-imperial-gold">Queen de Q, c'est la fin du bluff.</p>
              <p className="font-raleway">C'est le début d'un jeu où on choisit nos règles, nos cartes, notre vérité.</p>
              <p className="text-xl font-bold text-rose-champagne font-raleway">Pas pour plaire. Pour se couronner.</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
                      <h3 className="text-center font-cinzel text-3xl md:text-4xl font-bold text-imperial-gold mb-16">
              ...
              >
                <div className={`relative bg-gradient-to-br ${feature.gradient} p-8 rounded-3xl shadow-2xl border border-imperial-gold/30 h-full`}>
                  ...
                  <div className="relative z-10">
                    ...
                    <h4 className="font-cinzel text-2xl font-bold text-white text-center mb-6">
                      {feature.title}
                    </h4>
                    
                    <p className="text-white/90 text-center leading-relaxed font-raleway">
                      {feature.description}
                    </p>
                  </div>
        ...
        >
          <div className="relative inline-block">
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 300 }}
            >
              <h4 className="font-cinzel text-2xl md:text-3xl font-bold text-royal-purple mb-4">
                Participe au lancement virtuel!
              </h4>
              
              <motion.button
                className="bg-royal-purple text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-vintage-aubergine transition-all duration-300 shadow-lg border-2 border-white/30 font-raleway"
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <p className="text-rose-champagne/70 text-sm italic leading-relaxed font-raleway">
