          ...
          {!showResult ? (
            ...
            >
              ...
              <div className="text-center mb-16">
                ...
                >
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-playlist font-bold bg-gradient-to-r from-imperial-gold via-rose-champagne to-imperial-gold bg-clip-text text-transparent mb-4">
                    {t('quiz.title')}
                  </h1>
                  <p className="text-rose-champagne/80 text-xl mb-8 font-raleway">
                    {t('quiz.subtitle')}
                  </p>
              ...
              <fieldset className="mb-16">
                ...
                <motion.h2 
                  className="text-2xl md:text-3xl lg:text-4xl font-cinzel font-bold text-center mb-16 leading-relaxed"
                    ...
                    >
                      ...
                      <div className={`transition-opacity duration-500 ${isShuffling ? 'opacity-0' : 'opacity-100'}`}>
                        ...
                        <div className="text-center">
                          <p className="text-white font-medium text-lg leading-relaxed whitespace-pre-line group-hover:text-imperial-gold transition-colors duration-300 font-raleway">
                            {option.text}
                          </p>
                        </div>
                      </div>
              ...
              {result && (
                <>
                  <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-3xl p-12 border-2 border-imperial-gold/50 shadow-2xl shadow-imperial-gold/20">
                    ...
                    <motion.h2
                      className="text-3xl md:text-4xl lg:text-5xl font-cinzel font-bold mb-4"
