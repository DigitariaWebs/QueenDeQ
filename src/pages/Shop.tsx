    ...
    <main className="min-h-screen bg-gradient-to-br from-royal-purple via-vintage-aubergine to-inked-indigo px-6 pt-32 pb-12 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h1 className="font-playlist font-bold text-5xl bg-gradient-to-r from-imperial-gold via-rose-champagne to-antique-rose bg-clip-text text-transparent mb-4">
            {t('shop.title')}
          </h1>
                      <p className="text-rose-champagne/80 text-xl max-w-3xl mx-auto leading-relaxed font-raleway">
            {t('shop.subtitle')}
          </p>
        </motion.div>
