      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <h1 className="font-playlist font-bold text-4xl text-royal-purple">
              {t('journal.title')}
            </h1>
          </div>
          <p className="text-royal-purple/70 text-lg max-w-2xl mx-auto font-raleway">
            {t('journal.subtitle')}
          </p>
        </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-royal-purple/70 group-hover:text-royal-purple transition-colors font-raleway">
                  {t('journal.newEntry')}
                </span>
              </div>
            </button>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-royal-purple text-white rounded-lg hover:bg-royal-purple/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-raleway"
                >
                ...
                <button
                  ...
                  className="px-4 py-2 border border-rose-champagne/30 text-royal-purple rounded-lg hover:bg-rose-champagne/10 transition-colors font-raleway"
                >
                  {t('journal.cancel')}
                </button>
              </div>
        ...
        >
          {entries.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="font-cinzel font-bold text-xl text-royal-purple/60 mb-2">
                {t('journal.noEntries')}
              </h3>
                              <p className="text-royal-purple/40 font-raleway">
            ...
            entries.map((entry) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <h3 className="font-cinzel font-bold text-xl text-royal-purple">
                        {entry.title}
                      </h3>
                    </div>
                    <div className="flex items-center gap-4 text-sm text-royal-purple/60 font-raleway">
                ...
                <p className="text-royal-purple/80 leading-relaxed whitespace-pre-wrap font-raleway">
                  {entry.content}
                </p>
              </motion.div>
            ))
