        ...
        >
          ...
          <div className="relative z-10 p-8">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-cinzel font-bold text-imperial-gold mb-2 animate-cascade">
                {t('signup.title')}
              </h2>
              <p className="text-rose-champagne/80 animate-cascade font-raleway">
                {t('signup.description')}
              </p>
              {drawnCard && (
                <div className="mt-4 p-3 bg-imperial-gold/10 border border-imperial-gold/30 rounded-lg animate-cascade">
                  <p className="text-imperial-gold font-medium font-raleway">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="relative animate-cascade">
                <label className="block text-rose-champagne font-medium mb-2 font-raleway">
                  {t('signup.form.email')}
                </label>
