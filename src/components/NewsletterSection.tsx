    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          {/* Titre principal */}
          <h2 className="text-4xl md:text-5xl font-playlist font-bold text-imperial-gold mb-6">
            {t('newsletter.title')}
          </h2>

          {/* Sous-titre mystique */}
          <p className="text-xl md:text-2xl text-rose-champagne/90 mb-4 max-w-3xl mx-auto leading-relaxed font-cinzel">
            {t('newsletter.subtitle')}
          </p>

          <p className="text-lg text-rose-champagne/70 mb-12 max-w-2xl mx-auto font-raleway">
          ...
          <div className="max-w-md mx-auto">
            {!showSuccess ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative group">
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-imperial-gold to-yellow-300 hover:from-yellow-300 hover:to-yellow-400 text-black font-cinzel font-bold py-4 px-8 rounded-full transition-all duration-500 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-2xl hover:shadow-imperial-gold/30 relative overflow-hidden"
                  >
                    {/* Effet de brillance */}
              ...
              <div className="animate-fade-in">
                ...
                <h3 className="text-2xl font-cinzel font-bold text-green-400 mb-4">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-rose-champagne/70 font-raleway">{t('newsletter.stats.souls')}</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-imperial-gold mb-2">54</div>
              <p className="text-rose-champagne/70 font-raleway">{t('newsletter.stats.archetypes')}</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-imperial-gold mb-2">95%</div>
              <p className="text-rose-champagne/70 font-raleway">{t('newsletter.stats.transformations')}</p>
            </div>
          </div>
        </div>
      </div>
