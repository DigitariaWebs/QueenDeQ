...
export const Card: React.FC<CardProps> = ({ card, index, t }) => {
  ...
  return (
    ...
    >
      ...
      >
        <button
          className="card-container card-luxury golden-particles aspect-[7/12] relative w-full h-full rounded-lg overflow-hidden shadow-lg focus:outline-none focus:ring-2 focus:ring-imperial-gold focus:ring-offset-2 focus:ring-offset-royal-purple border border-imperial-gold/20 hover:border-imperial-gold/40 transition-all duration-300 hover:shadow-imperial-gold/20"
          onClick={handleFlip}
          ...
          >
            ...
            <div className="card-face absolute inset-0 rounded-lg bg-gradient-to-br from-royal-purple/90 to-royal-purple/70 backface-hidden">
              <div className="flex flex-col items-center justify-center h-full p-4">
                <div className="text-imperial-gold font-playlist font-bold text-lg text-center mb-2">
                  Queen de Q
                </div>
                <div className="text-rose-champagne/70 text-sm text-center font-raleway">
                  {t('card.archetype')}
                </div>
              </div>
              ...
              <div className="absolute bottom-2 left-2 right-2 text-center">
                <div className="text-imperial-gold font-cinzel font-bold text-sm">
                  {card.number}
                </div>
              </div>
            </div>
            ...
            <div className="card-back absolute inset-0 rounded-lg backface-hidden overflow-hidden rotate-y-180">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-3">
                <div className="text-imperial-gold font-cinzel font-bold text-sm text-center">
                  {card.name}
                </div>
              </div>
            </div>
