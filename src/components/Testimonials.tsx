      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-block relative">
            ...
            <h2 className="text-5xl sm:text-6xl lg:text-7xl font-playlist font-bold mb-8 relative">
          ...
          <p className="text-xl text-rose-champagne/80 max-w-2xl mx-auto leading-relaxed font-raleway">
              ...
              return (
                ...
                >
                  ...
                  <div className={`relative bg-gradient-to-br ${colors.bg} backdrop-blur-md border ${colors.border} rounded-2xl p-8 transition-all duration-500 group-hover:${colors.glow} group-hover:shadow-2xl`}>
                    ...
                    <div className="absolute top-3 right-3 w-8 h-8 opacity-30">
                     ...
                     <div className="flex items-start gap-4 mb-6">
                         ...
                         <div className={`w-14 h-14 ${colors.border} border-2 rounded-full overflow-hidden transform -rotate-3 transition-transform group-hover:rotate-0 shadow-lg`}>
                           <img 
                             ...
                             onError={(e) => {
                               ...
                               if (parent) {
                                 parent.innerHTML = `<div class="w-full h-full bg-gradient-to-br ${colors.bg} flex items-center justify-center font-bold text-lg text-rose-champagne font-raleway">${testimonial.name.charAt(0)}</div>`;
                               }
                             }}
                           />
                         </div>
                      ...
                      <div className="flex-1">
                        <h3 className="font-cinzel font-bold text-lg text-rose-champagne mb-1">
                          {testimonial.name}
                        </h3>
                        <p className={`text-sm font-medium ${colors.accent} font-raleway`}>
                    ...
                    <blockquote className="text-rose-champagne/90 leading-relaxed text-base relative mb-6 font-raleway">
                      {/* Opening quote */}
                      <span className={`${colors.accent} text-3xl absolute -top-2 -left-2 opacity-50 font-cinzel`}>"</span>
                      <span className="block pl-4">
                        {testimonial.text}
                      </span>
                      {/* Closing quote */}
                      <span className={`${colors.accent} text-3xl absolute -bottom-4 -right-2 opacity-50 font-cinzel`}>"</span>
                    </blockquote>

                    {/* Signature line */}
                    <div className="flex items-center justify-between pt-4 border-t border-rose-champagne/20">
                      <div className={`text-xs ${colors.accent} font-medium font-raleway`}>
