  ...
  return (
    ...
    >
      ...
      {[...Array(5)].map((_, i) => (
        ...
        >
          {/* Card front pattern with mystical engraved text */}
          <div className="absolute inset-2 rounded border border-imperial-gold/20 bg-royal-purple/50">
            <div className="absolute inset-2 rounded border border-imperial-gold/10 bg-gradient-to-br from-transparent to-imperial-gold/5">
              ...
              {/* Mystical engraved text on front face */}
              <div className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 translate-y-1/2 text-center px-3">
                <div className="space-y-1">
                  <div 
                    className="font-cinzel text-xs md:text-sm text-imperial-gold/70 font-light italic leading-tight tracking-wider"
                    style={{ 
                      textShadow: '0 0 8px rgba(214, 174, 96, 0.3), inset 0 1px 0 rgba(214, 174, 96, 0.1)',
                      letterSpacing: '0.5px'
                    }}
                  >
