...
interface LiveTeaBannerProps {
  onOpenInscriptionForm?: () => void;
}

export const LiveTeaBanner: React.FC<LiveTeaBannerProps> = ({ onOpenInscriptionForm }) => {
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <span className="ml-2 text-white/90 font-raleway">{t('liveTeaTime.date')}</span>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onOpenInscriptionForm}
          >
            <Bell size={16} />
            <span className="text-sm font-medium font-raleway">{t('liveTeaTime.reminder')}</span>
          </motion.button>
