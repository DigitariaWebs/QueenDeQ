  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/assets/sprites/54-cards.png')`,
      ...
      {isPlaying && (
        <button
          onClick={handleCardDraw}
                      className="mt-6 px-8 py-3 bg-imperial-gold hover:bg-imperial-gold/90 text-royal-purple font-cinzel font-bold text-lg rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-imperial-gold/30"
        >
          {t('cardDeck.dealCard')}
        </button>
      )}
      ...
      {!isPlaying && drawnCard && (
        <div className="mt-6 text-center">
                      <h3 className="text-imperial-gold font-cinzel font-bold text-xl mb-2">
            {t('cardDeck.yourArchetype')}
          </h3>
                      <p className="text-rose-champagne font-raleway text-lg">
            {drawnCard}
          </p>
        </div>
      )}
