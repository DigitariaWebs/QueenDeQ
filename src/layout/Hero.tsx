...
export const Hero: React.FC = () => {
  ...
  return (
    <>
      <section
        id="hero"
        className="grid lg:grid-cols-[60%_40%] w-screen min-h-screen overflow-hidden"
      >
        {/* LEFT column = headline, CTA, badge */}
        <div className="relative bg-gradient-to-br from-royal-purple via-royal-purple/95 to-royal-purple/90 flex items-center justify-center p-2 pb-0 sm:p-8 lg:p-16 pt-16 lg:pt-16 hidden sm:flex">
          <div className="max-w-2xl w-full mx-auto">
            ...
            <div className="mb-8 sm:mb-12 relative">
              ...
              <div
                className="mb-2 sm:mb-8 relative overflow-visible text-center sm:text-left"
                style={{ minHeight: "100px", paddingBottom: "0.3rem" }}
              >
                <h1
          ...
          >
              ...
              <img
                ...
                onClick={() =>
                  (window.location.href =
                    "https://queen-de-q-platform-v2.vercel.app/")
                }
              />
            </motion.div>
            ...
            >
              ...
              <p className="text-lg md:text-xl font-raleway text-rose-champagne/90 leading-relaxed max-w-sm">
                Découvre ton véritable potentiel et rejoins une sororité de
                femmes avec qui grandir et partager
              </p>
              <motion.button
                onClick={() =>
                  (window.location.href =
